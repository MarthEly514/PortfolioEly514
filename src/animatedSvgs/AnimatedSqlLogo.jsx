...
export const AnimatedSqlLogo = ({
    ...
    return (
        <motion.svg
            ...
            initial={{ transform: 0, opacity: 1 }}
            whileHover={{ pathLength: 1, opacity: 1, strokeWidth: 0.2 }}
        >
...
export default AnimatedSqlLogo;