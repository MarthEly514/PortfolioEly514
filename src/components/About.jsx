    ...
    <>
      <div className=' w-full h-300 min-h-max bg-bg dark:bg-bg-dark z-10'>
        <div className='w-full lg:w-[80%] max-w-7xl px-12 py-9 flex flex-col items-center mx-auto'>
          ...
          {/* Image with blobs */}
          <motion.div
            className='w-full h-100 min-h-max flex flex-col md:flex-row items-center justify-between'
            ...
            >
            <ImageBlob />
            <p className='w-1/2 pr-8 text-2xl text-secondary-text dark:text-secondary-text-dark'>
