...
export default function Skills() {
  ...
  return (
    <div className=' w-full pb-10 xl:pb-32 min-h-max bg-bg dark:bg-bg-dark z-10'>
      <div className='w-full lg:w-[80%] max-w-7xl px-5 lg:px-12 py-9 flex flex-col items-center mx-auto'>
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.3 }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="skill-container w-full xl:w-[70%] max-w-300 h-max xl:aspect-7/3 md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-rows-3 xl:grid-cols-6 gap-2.5 my-12 mt-28">
